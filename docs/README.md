...
| PRF.001 | Производительность | Система должна обеспечивать производительность путем обработки до 1000 запросов в секунду и проведения онлайн трансляции без задержек | На регулярной основе (каждые 5 минут) производится мониторинг производительности системы с помощью специализированных инструментов, позволяющих анализировать данные метрик |
| CFG.001 | Совместимость | Система должна быть совместима с веб-браузерами: Google Chrome версии 91 и выше, Mozilla Firefox версии 89 и выше, Opera версии 76 и выше, Safari версии 12 и выше, Яндекс. Браузер версии 22 и выше  и базами данных без необходимости изменения ее основной архитектуры. Система должна быть совместима с Zoom для проведения трансляций | - |
| DAT.001 | Согласованность данных | Система должна обеспечивать согласованность и целостность данных, используемых различными сервисами, чтобы избежать возможных ошибок и несоответствий в информации в части работы с докладами и расписаниями | 1. Определение единого формата для хранения данных с использованием сквозного идентификатора. 2. Разработка процесса синхронизации данных между ACID и BASE базами данных, включая определение правил для обновления и удаления данных. 3. Разработка механизмов обработки ошибок и конфликтов данных, которые могут возникнуть в процессе синхронизации. 4. Разработка мониторинговых инструментов для отслеживания правильности и целостности данных. 5. Разработка мониторинговых и аналитических инструментов для автоматического выявления дубликатов данных и конфликтов при синхронизации | 
| SCL.001 | Автоматическое масштабирование | Система должна быть способна обрабатывать удвоенный объем пользовательского трафика за период в одну неделю в результате проведения крупномасштабной конференции. Необходимо убедиться, что применяемые алгоритмы масштабирования не нарушат способность баз данных гарантировать целостность данных в условиях распределенности и высокой нагрузки | 1. Установить систему мониторинга, которая отслеживает нагрузку на систему, количество пользователей и потребляемые ресурсы. 2. Определить пороговые значения для каждого показателя, которые указывают на необходимость масштабирования. 3. Создать автоматический процесс, который будет мониторингом систему и ее базы данных с определенной периодичностью. 4. Если любой из показателей достигает порогового значения, система должна автоматически инициировать масштабирование. 5. На этапе масштабирования необходимо расширить число серверов в кластере, а также увеличить ресурсы баз данных для поддержки новых пользователей. 6. После масштабирования система должна продолжить работу в обычном режиме | 
| INT.001 | Возможность взаимодействия | Система должна обеспечивать надежную и эффективную интеграцию со своими сервисами с использованием смешанной интеграции | - |
...
- [ADR.002 Сравнение протоколов взаимодействия](adr/adr.002.md)

### [Контекст решения](context/context.md)
### [Диаграмма ограниченных контекстов](context/boundedContext.md)

### [Компонентная архитектура](components/components.md)
### [Диаграмма контейнеров для всех ограниченных контекстов](components/componentsForBoundedContext.md)
